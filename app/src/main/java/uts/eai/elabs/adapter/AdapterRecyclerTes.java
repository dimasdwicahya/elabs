...
public class AdapterRecyclerTes extends RecyclerView.Adapter<AdapterRecyclerTes.ViewHolder> {

    private List<DataTes> items;
    private SparseIntArray mSelections;

    public AdapterRecyclerTes(List<DataTes> items) {
        this.items = items;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_row_question_tes, parent, false);
        return new ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        DataTes item = items.get(position);
...
//        holder.jawaban.setText(item.getJawaban());
    ...
    public List<DataTes> getAllAnswer(){
        return items;
    }
